...
class Node:
    ...
    def draw_node(self, ax=None, maxdepth:int|None=None, size:float=0.25, lw:float=0.8, dx:float=0, dy:float=0):
        """ノードと子ノードの関係を描画する.
...
class Mbtree:
    ...
    def draw_tree(self, startnode:Node|None=None, size:float=0.25, lw:float=0.8, maxdepth:int=2):
        """ゲーム木の部分木を描画する.
