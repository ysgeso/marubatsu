...
class Marubatsu:
    ...
    def play(self, ai:list, ai_dict:dict|None=None, params:list[dict]|None=None, names:list[str|None]=None, verbose:bool=True, seed:bool|None=None, gui:bool=False, size:float=3) -> str | None:
        """〇×ゲームをプレイする.
...
class Marubatsu_GUI(GUI):
    ...
    def __init__(self, mb:Marubatsu, params:list|None, names:list|None, ai_dict:dict|None, seed:int, size:int):
