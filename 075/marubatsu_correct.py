...
class Marubatsu:
    ...
    def play(self, ai:list, ai_list:list=[], params:list[dict]=[{}, {}], verbose:bool=True, seed:bool|None=None, gui:bool=False, size:float=3) -> str | None:
        """〇×ゲームをプレイする.
        ...
        Args:
            ...
            ai_list:
                gui=True の場合に、Dropdown で選択できる AI の一覧を表す list
            params:
    ...
    def play_loop(self, ai:list, ax, params:list[dict]=[{}, {}], verbose:bool=True, gui:bool=False) -> str | None:
