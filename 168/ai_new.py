...
def ai_by_score(eval_func):
    ...
    @wraps(eval_func)
    def wrapper(mb_orig:Marubatsu, debug:bool=False, *args, rand:bool=True, analyze:bool=False, calc_score:bool=False, **kwargs):
...
@ai_by_score
def ai_mmdfs_tt(mb:Marubatsu, debug:bool=False, shortest_victory:bool=False):
...
def ai_abs_tt3(mb:Marubatsu, debug:bool=False, shortest_victory:bool=False):   
    ...
    ai_abs_tt2 との違いは、置換票に下界と上界を記録処理を改良した点である
...
def ai_abs_all(mb:Marubatsu, debug:bool=False, shortest_victory:bool=False,
               init_ab:bool=False, use_tt:bool=False, ai_for_mo=None,
...
def ai_mdtf(mb, debug=False, shortest_victory=False,
