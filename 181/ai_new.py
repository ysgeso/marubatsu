...
def ai_match(ai:list, params:list[dict]=[{}, {}], match_num:int=10000) -> dict:
...
@ai_by_score
def ai_mmdfs(mb:Marubatsu, debug:bool=False):
...
@ai_by_score
def ai_mmdfs_tt(mb:Marubatsu, debug:bool=False, tt:dict|None=None, shortest_victory:bool=False):
...
@ai_by_score
def ai_abs(mb:Marubatsu, debug:bool=False):   
...
@ai_by_score
def ai_abs2(mb:Marubatsu, debug:bool=False): 
    """アルファベータ法で評価値を動的に計算する強解決の AI
...
@ai_by_score
def ai_abs3(mb:Marubatsu, debug:bool=False):   
    """アルファベータ法で評価値を動的に計算する強解決の AI
...
@ai_by_score
def ai_abs_tt(mb:Marubatsu, debug:bool=False, shortest_victory:bool=False):   
...
@ai_by_score
def ai_abs_tt2(mb:Marubatsu, debug:bool=False, shortest_victory:bool=False):   
...
@ai_by_score
def ai_abs_tt3(mb:Marubatsu, debug:bool=False, shortest_victory:bool=False):   
    """ミニマックス値の下界と上界を記録した置換表を利用したアルファベータ法で評価値を動的に計算する強解決の AI
...
@ai_by_score
def ai_abs_tt4(mb:Marubatsu, debug:bool=False, shortest_victory:bool=False):   
    """ミニマックス値の下界と上界を記録した置換表を利用したアルファベータ法で評価値を動的に計算する強解決の AI
...
def ai_mmdfs_all(mb:Marubatsu, debug:bool=False, use_tt:bool=False,
                 tt:dict|None=None, shortest_victory:bool=False):
    """置換表を利用したミニマックス法で評価値を動的に計算する強解決の AI
...
def ai_abs_all(mb:Marubatsu, debug:bool=False, shortest_victory:bool=False,
               ...
               params:dict={}, sort_allnodes:bool=False, calc_count:bool=False) -> float:    
...
@ai_by_mmscore
def ai_abs_dls(mb:Marubatsu, debug:bool=False, timelimit_pc:float|None=None, maxdepth:int=1, eval_func=None, eval_params:dict={},
...
def ai_ab_iddfs(mb:Marubatsu, debug:bool=False, timelimit:float=10, eval_func=None, eval_params:dict={}, use_tt:bool=False, share_tt:bool=False, analyze:bool=False) -> tuple[int, int]:
