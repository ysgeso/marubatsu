...
class Node:
    ...
    def __init__(self, mb:Marubatsu, parent=None, depth:int=0, bestmoves_by_board:dict|None=None):
        """ イニシャライザ.
    ...
    def calc_children(self, bestmoves_by_board:dict|None=None):
        """子ノードを計算する
...
class Mbtree:
    ...
    def __init__(self, algo:str="bf", shortest_victory:bool=False, subtree:dict|None=None):
        """イニシャライザ.
...
class Mbtree_GUI(GUI):
    ...
    def __init__(self, mbtree:Mbtree, show_score:bool=True, size:float=0.15):
        """イニシャライザ.
